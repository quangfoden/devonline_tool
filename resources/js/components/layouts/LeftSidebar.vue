        ...
        <ul class="metismenu list-unstyled" id="side-menu">
            ...
            <ul class="sub-menu" aria-expanded="false">
              ...
              <li>
                <router-link
                  ...
                  exact-active-class="active"
                  :class="{
                    'mm-active': ['All Post', 'Create Post', 'Post Detail'].includes(
                      $route.name
                    ),
                  }"
                >
          ...
          <li>
            <router-link
              ...
              tag="li"
              :class="{
                'mm-active': ['All Product', 'Create Product', 'Game Product'].includes(
                  $route.name
                ),
              }"
          ...
          <li>
            <router-link
              ...
              tag="li"
              :class="{
                'mm-active': ['All Contact', 'Contact Detail'].includes($route.name),
              }"
          ...
          <li
            :class="{
              'mm-active': $route.name === 'All Roles' || $route.name === 'Add Role',
            }"
          ...
          <li
            :class="{
              'mm-active':
                $route.name === 'All Permissions' || $route.name === 'Add Permission',
            }"
            v-if="checkPermission(['Role Manager'])"
          >
            <a
...
} from "@resources/js/middleware/access.js";
